...
```bash
npm install @YueArifureta/yue-Bail
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```bash
yarn add @YueArifureta/yue-Bail@latest
```

Then import your code using:
```javascript
const { default: makeWASocket } = require("@YueArifureta/yue-Bail")
```
...
```javascript
const makeWASocket = require("@YueArifureta/yue-Bail").default;
const { useMultiFileAuthState } = require("@YueArifureta/yue-Bail");
...
```javascript
const makeWASocket = require("@YueArifureta/yue-Bail").default;
const { DisconnectReason, useMultiFileAuthState } = require("@YueArifureta/yue-Bail");
...
```javascript
const makeWASocket = require("@YueArifureta/yue-Bail").default;
const { makeInMemoryStore } = require("@YueArifureta/yue-Bail");
...
const { downloadMediaMessage, getContentType } = require("@YueArifureta/yue-Bail");
